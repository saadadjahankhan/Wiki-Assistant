...
scrol=Scrollbar(bottom,background="grey")#414e4e
scrol.pack(side=RIGHT,fill=Y)
text=Text(bottom,wrap=WORD,yscrollcommand=scrol.set,background="white",undo=True)
text.insert(INSERT,"Result will appear here!")
text.pack()
